#1) Hacer un programa que gestiones datos para una escuela. El programa tiene que ser capaz de:
...
Donde cada alumno es otro diccionario estructurado de la siguiente forma:
{
...
Datos[“Alumnos”][2][“DNI”]
Este es un ejemplo de estructura, se puede cambiar completamente o hacer algunos cambios sobre el para mejorar el orden 
